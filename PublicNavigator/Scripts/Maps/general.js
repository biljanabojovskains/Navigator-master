...
for (var layer in layersToAdd) {
    switch (layersToAdd[layer]) {
        ...
        case 'layerOsmLocal':
            ...
            break;
        case 'layerPOI':
            layers.push(layerPOI);
            break;
        case 'layerBiznisPOI':
            layers.push(layerBiznisPOI);
            break;
        case 'layerKZ':
            layers.push(layerKZ);
            break;
        case 'vectorMeasure':
            layers.push(vectorMeasure);
            break;
...
for (var layer in layersOff) {
    switch (layersOff[layer]) {
        ...
        case 'layerPOI':
            ...
            break;
        case 'layerBiznisPOI':
            layerBiznisPOI.setVisible(false);
            break;
        case 'layerKZ':
            layerKZ.setVisible(false);
            break;
        case 'vectorMeasure':
            vectorMeasure.setVisible(false);
            break;
        case 'layerOrtofotoCache':
